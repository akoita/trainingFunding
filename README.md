...
hurl invoke trainingOffer trainingOffer_create "{\"name\":\"my first request\",\"id\":\"0001\",\"created\":0,\"modified\":0}"
```
...
npm run cc:package -- trainingOffer org1
# Install to your blockchain - From the root of your project
hurl install trainingOffer node -P ./chaincode-trainingOffer
# Install in debug mode, this will run the chaincode server locally so you can debug
hurl install trainingOffer node -P ./chaincode-trainingOffer --debug

# Upgrade your existing chaincode - From the root of your project
hurl upgrade trainingOffer node 1.2 -P ./chaincode-trainingOffer
```
...
# Upgrade your existing chaincode - From the root of your project
npm run cc:upgrade -- trainingOffer 1.2
```
