...
describe('TrainingOffer', function () {
    var adapter;
    var trainingOfferCtrl;
    before(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    adapter = new convector_adapter_mock_1.MockControllerAdapter();
                    trainingOfferCtrl = convector_core_1.ClientFactory(src_1.TrainingOfferController, adapter);
    ...
    it('should create a default model', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    modelSample = new src_1.TrainingOffer({
                        id: uuid(),
                        name: 'Test',
                        created: Date.now(),
                        modified: Date.now()
                    });
                    return [4, trainingOfferCtrl.create(modelSample)];
                case 1:
                    _a.sent();
...
//# sourceMappingURL=trainingOffer.spec.js.map