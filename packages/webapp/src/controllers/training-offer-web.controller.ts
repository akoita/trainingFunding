...
export class TrainingOfferWebController {
  constructor(
    @inject('TrainingOfferControllerBackEnd')
    private trainingOfferFabricController: ConvectorControllerClient<
      TrainingOfferController
    >,
  ) {}
  ...
  public async closeTrainingOffer(
    ...
    await this.trainingOfferFabricController.closeTrainingOffer(
      trainingOfferId,
    );
  }
