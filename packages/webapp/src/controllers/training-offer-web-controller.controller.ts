...
export class TrainingOfferWebControllerController {
  ...
  public async getTrainingOfferById(
    ...
    return await TrainingOfferControllerBackEnd.getTrainingOfferById(
      trainingOfferId,
    );
  }
  ...
  public async closeTrainingOffer(
    ...
    await TrainingOfferControllerBackEnd.closeTrainingOffer(trainingOfferId);
  }
  ...
  public async searchTrainingOffersByTitleOrDescription(
    ...
    return await TrainingOfferControllerBackEnd.searchTrainingOffersByTitleOrDescription(
      keyword,
    );
  }
  ...
  public async searchTrainingOffersByDomain(
    ...
    return await TrainingOfferControllerBackEnd.searchTrainingOffersByDomain(
      domain,
    );
  }
  ...
  public async searchTrainingOffersByDomainAndLevel(
    ...
    return await TrainingOfferControllerBackEnd.searchTrainingOffersByDomainAndLevel(
      domain,
      level,
    );
  }
